...
b1.photos.attach(io: cl_p2, filename: 'cl_p2.jpg')
b1.photos.attach(io: cl_p3, filename: 'cl_p3.jpg')
...
b2.photos.attach(io: mfc_p3, filename: 'mfc_p3.jpg')
...
b3.photos.attach(io: ts_p3, filename: 'ts_p3.jpg')
b4.profile_picture.attach(io: cg_pp, filename: 'cg_pp.jpg')
b4.photos.attach(io: cg_p1, filename: 'cg_p1.jpg')
b4.photos.attach(io: cg_p2, filename: 'cg_p2.jpg')
b4.photos.attach(io: cg_p3, filename: 'cg_p3.jpg')
b5.profile_picture.attach(io: ch_pp, filename: 'ch_pp.jpg')
b5.photos.attach(io: ch_p1, filename: 'ch_p1.jpg')
b5.photos.attach(io: ch_p2, filename: 'ch_p2.jpg')
b5.photos.attach(io: ch_p3, filename: 'ch_p3.jpg')